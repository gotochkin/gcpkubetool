...
RUN cd && \
    curl -L https://github.com/derailed/k9s/releases/download/v0.26.6/k9s_Linux_x86_64.tar.gz | tar xz  -C /usr/bin && \
...
#Adding Helm
RUN curl -L https://get.helm.sh/helm-v3.10.0-linux-amd64.tar.gz | tar xz -C /root && \ 
